...
public abstract class ExpandedGridAdapter extends BaseExpandAdapter {
    ...
    public void setLayoutManager() {
        ...
        gridLayoutManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
            ...
            public int getSpanSize(int position) {
                ...
                switch (viewType) {
                    case ExpandedRecyclerConstant.VIEW_TYPE_CHILD:
                        return columnNumber;
                    case ExpandedRecyclerConstant.VIEW_TYPE_EMPTY:
                        return 1;
                    default:
                        return 1;
                }
    ...
    final public int getItemViewType(int position) {
        if (position == currentExpandedIndex) {
            return ExpandedRecyclerConstant.VIEW_TYPE_CHILD;
        } else if (Utility.updatedIndex(currentExpandedIndex, position) < (iExpandDatas.size())) {
            return ExpandedRecyclerConstant.VIEW_TYPE_PARENT;
        }
        return ExpandedRecyclerConstant.VIEW_TYPE_EMPTY;
    }
