package com.chayan.toggleswitch.widgets
...
import com.chayan.toggleswitch.R
import java.util.*
...
abstract class BaseToggleSwitch : LinearLayout, ToggleSwitchButton.Listener {
    ...
    companion object Default {
        ...
        @JvmStatic private val CHECKED_BACKGROUND_COLOR    = R.color.green
        @JvmStatic private val CHECKED_BORDER_COLOR        = R.color.green
        ...
        @JvmStatic private val TEXT_SIZE                   = 15f

        @JvmStatic private val TOGGLE_DISTANCE             = 0f
        @JvmStatic private val TOGGLE_ELEVATION            = 0f
        @JvmStatic private val TOGGLE_HEIGHT               = 30f
        @JvmStatic private val TOGGLE_WIDTH                = 72f

        @JvmStatic private val UNCHECKED_BACKGROUND_COLOR  = android.R.color.white
        ...
        if (attrs != null) {
            ...
            try {
                ...
                if (entries == null || entries.isEmpty()) {
                    ...
                    val textToggleLeft : String?  = attributes.getString(R.styleable.BaseToggleSwitch_textToggleLeft)
                    val textToggleRight : String? = attributes.getString(R.styleable.BaseToggleSwitch_textToggleRight)
